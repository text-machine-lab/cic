...
class CornellMovieConversationDataset(arcadian.dataset.Dataset):
    def __init__(self, max_s_len, reverse_inputs=False, seed='seed', stop_token='<STOP>', save_dir=None):
        nlp = spacy.load('en')
        ...
        self.examples, self.messages, self.responses, self.vocab, self.inverse_vocab\
            = cic.models.old_chat_model.preprocess_all_cornell_conversations(nlp, reverse_inputs=reverse_inputs,
                                                                             verbose=True,
